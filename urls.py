...
urlpatterns = patterns('',
    ...
    (r'^edit/(?P<section>personal|location|public)/done/$', direct_to_template, {'template': 'userprofile/profile_done.html'}),
    ...
    (r'^edit/public/$', makepublic, { 'section': 'makepublic', 'APIKEY': settings.APIKEY, 'template': 'userprofile/makepublic.html'}),
