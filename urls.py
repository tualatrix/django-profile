...
urlpatterns = patterns('',
    ...
    (r'^profile/edit/avatar/$', avatarchoose, { 'section': 'avatar', 'websearch': WEBSEARCH, 'template': 'userprofile/avatar/choose.html'}),
    (r'^profile/edit/avatar/delete/$', avatardelete),
    (r'^profile/edit/avatar/search/$', searchimages, { 'section': 'avatar', 'template': 'userprofile/avatar/search.html'}),
    (r'^profile/edit/avatar/crop/$', avatarcrop, { 'section': 'avatar', 'template': 'userprofile/avatar/crop.html'}),
    (r'^profile/edit/avatar/crop/done/$', direct_to_template, { 'section': 'avatar', 'template': 'userprofile/avatar/done.html'}),
