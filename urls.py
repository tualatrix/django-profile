...
urlpatterns = patterns('',
    ...
    (r'^profile/edit/(?P<section>personal|location|public)/done/$', direct_to_template, {'template': 'userprofile/profile/profile_done.html'}),
    ...
    (r'^profile/edit/avatar/search/(?P<keyword>[A-Za-z0-9\-_\.]+)$', searchimages, { 'section': 'avatar', 'template': 'userprofile/avatar/avatar_search.html'}),
    ...
    (r'^validation/reset/$', validation_reset, {'template' : 'userprofile/account/validation_reset.html'}),
    (r'^validation/reset/done/(?P<action>success|failed)/$', direct_to_template, {'template' : 'userprofile/account/validation_reset_done.html'}),
    ...
    (r'^email/change/$', email_change, { 'section': 'overview', 'template': 'userprofile/account/email_change.html'}),
    (r'^email/change/processed/$', direct_to_template, { 'extra_context': {'section': 'overview'}, 'template': 'userprofile/account/email_change_processed.html'}),
    (r'^email/change/(?P<key>.{70})/$', change_email_with_key, { 'section': 'overview', 'template': 'userprofile/account/email_change_done.html'}),
